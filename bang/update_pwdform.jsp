...
<%
//넘어온 userid를 userid1로 변수선언.. 이거 또 넘겨야함ㅋㅋㅋㅋㅋ
...
<div style ="text-align:center; position: absolute; height:100px; margin-left: 50px;">
  <br><br>
  <h1>비밀번호 변경 페이지</h1><br>
  <form method="post" action="update_pwdprocess.jsp?userid2=<%=userid1%>">
          <tr>
            <td width="80%">*</td>
            <label for="Memail">현재 비밀번호: </label>
            <td><input type="text" name ="prepwd" id="prepwd"></td>
        </tr><br><br>
        <tr >
            <td width="5%" >*</td>
            <label for="Memail">변경 비밀번호: </label>
            <td><input type="password" name="newpwd" id="newpwd" onchange="check_pw()"></td>
        </tr><br><br>
        <tr>
            <td width="5%" >*</td>
            <label for="Memail">비밀번호 재확인: </label>
            <td><input type="password" name="newpwd2" id="newpwd2" onchange="check_pw()">&nbsp;<span id="check"></span></td>
            </tr><br><br>
            <td><input type="submit" value="변경하기"></td></input>
          </form>
